...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => ($this->targetDirs[3].'/src/FirstBundle/Entity'))), 'FirstBundle\\Entity');

$a->setEntityNamespaces(array('FirstBundle' => 'FirstBundle\\Entity'));
